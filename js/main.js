...
async function showUserMenu() {
    ...
    menu.style.cssText = `
        position: absolute; top: 100%; right: 0; background: #2a2b36;
        border-radius: 8px; box-shadow: 0 5px 20px rgba(0,0,0,0.3);
        padding: 1rem; min-width: 300px; z-index: 1000; margin-top: 10px;
    `;
    ...
    menu.innerHTML = `
        <div style="padding: 0.5rem; border-bottom: 1px solid #40444b;">
            <div style="display: flex; align-items: center; gap: 10px;">
                ...
                <div>
                    <div style="color: white; font-weight: 600;">
                        ${authData.username}
                        ${badges.verified ? '<img src="https://cdn3.emoji.gg/emojis/32765-verifiedtwitter.gif" style="width: 16px; height: 16px; margin-left: 5px;">' : ''}
                    </div>
                    <div style="font-size: 0.8rem; color: #b9bbbe;">ID: ${authData.id}</div>
                </div>
            </div>
            <div style="display: flex; justify-content: space-between; margin-top: 10px;">
                <span>Баланс:</span>
                <span style="color: #57F287; font-weight: 600;">${authData.balance || 0} ₽</span>
            </div>
        </div>
        <a href="/profile.html" class="menu-item"><i class="fas fa-user"></i> Профиль</a>
        <a href="/profile.html#orders" class="menu-item"><i class="fas fa-shopping-bag"></i> Мои заказы</a>
        <a href="/profile.html#balance" class="menu-item"><i class="fas fa-coins"></i> Баланс</a>
        ${isAdminUser ? '<a href="/admin.html" class="menu-item"><i class="fas fa-crown"></i> Админ панель</a>' : ''}
        <hr style="border-color: #40444b;">
        <button onclick="logout()" class="menu-item" style="color: #ED4245; width: 100%; text-align: left;">
